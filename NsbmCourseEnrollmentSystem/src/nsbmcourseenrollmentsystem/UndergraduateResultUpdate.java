 ...
 */
public class UndergraduateResultUpdate extends javax.swing.JFrame {
DBOperation DBop = new DBOperation();
    /**
     * Creates new form UndergraduateResultUpdate
     */
    public UndergraduateResultUpdate() {
        initComponents();
    }
    void calResult(){
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
       UndergraduateResultDetails posd = new UndergraduateResultDetails();
        ...
        boolean result = DBop.updateUndergraduateResult(posd);  // parse add UndergraduateStudentDetails to add employee method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UndergraduateResultUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UndergraduateResultUpdate().setVisible(true);
            }
        });
    }
