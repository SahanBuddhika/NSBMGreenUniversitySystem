 ...
 */
public class UndergraduateCourseChooseDetails extends AbstractTableModel {
    private static final String[] COLUMN_NAMES = {"Student ID","Course ID","Faculty","Year Of Registration"};
    private static ArrayList<UndergraduateStudetsCourseRegDetails> list;
    
    UndergraduateCourseChooseDetails(ArrayList<UndergraduateStudetsCourseRegDetails> stList){
        list = stList;}
