 ...
 */
public class InstructerRegistration extends javax.swing.JFrame {
    DBOperation DBop = new DBOperation();
    /**
     * Creates new form InstructerRegistration
     */
    public InstructerRegistration() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("INSTRUCTER'S REGISTRATION");
    ...
    private void btnproceedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnproceedActionPerformed
        try{
            InstructerDetails posd = new InstructerDetails();
            ...
            boolean result = DBop.addInstructerDetails(posd);  // parse add UndergraduateStudentDetails to add employee method
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstructerRegistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InstructerRegistration().setVisible(true);
            }
        });
    }
