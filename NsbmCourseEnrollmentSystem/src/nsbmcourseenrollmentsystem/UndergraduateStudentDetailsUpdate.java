 ...
 */
public class UndergraduateStudentDetailsUpdate extends javax.swing.JFrame {

    /**
     * Creates new form UndergraduateStudentDetailsUpdate
     */
    DBOperation dbOP = new DBOperation();
    
    public UndergraduateStudentDetailsUpdate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("UNDERGRADUATE STUDENTS UPDATE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            UndergraduateStudentDetails und = new UndergraduateStudentDetails();// after the update the loading grid again save changs
                ...
                und.setAlresults(txtalresults.getText());
                und.setDistrictrank(new Integer(txtdistrictrank.getText()).intValue());
                
                if(dbOP.updateUndergraduateStudent(und)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UndergraduateStudentDetailsUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UndergraduateStudentDetailsUpdate().setVisible(true);
            }
        });
    }
